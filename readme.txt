 ...
 This will deploy two artifacts, target/weld-tests.war and
 default-ds.xml.
 ...
 - http://localhost:8080/weld-tests/
 ...
 Now you can either deploy the target/weld-tests.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/weld-tests.war

 To undeploy the application, run:

  ./asadmin undeploy weld-tests
